        ...
        if(data.characters !== null) {
            $.each(data.characters, function (index, char) {
                if (char.charid !== 0) {
                    ...
                    $('[data-charid=' + charid + ']').html('<h3 class="character-fullname">'+ char.firstname +' '+ char.lastname +'</h3><hr class="character-hr"><div class="character-info"><p class="character-info-work"><strong>Arbete: </strong><span>'+ char.job +'</span></p><p class="character-info-money"><strong>Kontanter: </strong><span>'+ char.money +'</span></p><p class="character-info-bank"><strong>Bankkonto: </strong><span>'+ char.bank +'</span></p><br><p class="character-info-dateofbirth"><strong>Personnummer: </strong><span>'+ char.dateofbirth +'</span></p> <p class="character-info-gender"><strong>Könsidentitet: </strong><span>'+ char.sex +'</span></p></div>').attr("data-ischar", "true");
                }
            });
        }
    };
