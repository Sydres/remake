$('document').ready(function() {
    ...
    containers.on('drop',function(el,target,source,sibling){
        if (source.id == 'drag1' && source.id != target.id) {
            ...
            $(`#${el.id}`).css('background-color', 'rgba(228, 228, 228, 0.2)');
    ...
    $('body').on('click', '.default', (event)=> {
        ...
        $('#drag2').children().css('background-color', 'rgba(228, 228, 228, 0.1)');
        $('#drag2').children().removeClass('selected');
        $('#money').removeClass('selected');
        $('#money').css('background-color', 'rgba(228, 228, 228, 0.1)');
        $('#blackcash').removeClass('selected');
        $('#blackcash').css('background-color', 'rgba(228, 228, 228, 0.1)');
        $(`#${selectedItem}`).addClass('selected');
        $(`#${selectedItem}`).css('background-color', 'rgba(228, 228, 228, 0.2)');
    })
    ...
    document.getElementById('money').addEventListener('click', function(event) {
        ...
        $(`#money`).css('background-color', 'rgba(228, 228, 228, 0.2)');
    })
    ...
    document.getElementById('blackcash').addEventListener('click', function(event) {
        ...
        $(`#blackcash`).css('background-color', 'rgba(228, 228, 228, 0.2)');
    })
